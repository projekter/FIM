...
abstract class Table implements fimSerializable {
   ...
   protected function __construct() {
      if(!isset(static::$columns))
         throw new TableException(I18N::getInternalLocale()->get(['table', 'definitionInvalid'],
            [get_class($this)]));
   }

   public final function __get($name) {
      if(!isset($this->fields))
         throw new TableException(I18N::getInternalLocale()->get(['table', 'deleted'],
            [static::getStaticStorage('tableName')]));
      if(isset($this->fields[$name]) || @array_key_exists($name, $this->fields))
         return $this->fields[$name];
      else
         throw new TableException(I18N::getInternalLocale()->get(['table', 'field',
   ...
   public final function __sleep() {
      throw new TableException(I18N::getInternalLocale()->get(['table', 'serialize']));
   }

   public final function __wakeup() {
      throw new TableException(I18N::getInternalLocale()->get(['table', 'unserialize']));
   }
