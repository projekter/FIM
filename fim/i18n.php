...
class I18N {
   ...
   protected function __construct($name, ResourceBundle $bundle = null) {
      if($bundle === null) {
         # Oh yes, that is ugly. But remember we don't want to have this
         # pseudo-class available. This should not occur when FIM is set up
         # correctly.
         if(!class_exists('\\fim\\noLanguage', false))
            eval('namespace fim; class noLanguage { public function get($key) { return $key; } }');
         $this->bundle = new \fim\noLanguage();
      ...
      if(Locale::getRegion($name) == null) {
         ...
         static $defaultRegions = [ // <editor-fold desc="Default regions" defaultstate="collapsed">
            'af' => 'af_ZA', 'am' => 'am_ET', 'ar' => 'ar_AE', 'as' => 'as_IN', 'ba' => 'ba_RU',
            'be' => 'be_BY', 'bg' => 'bg_BG', 'bn' => 'bn_IN', 'bo' => 'bo_CN', 'br' => 'br_FR',
            'bs' => 'bs_Latn', 'ca' => 'ca_ES', 'co' => 'co_FR', 'cs' => 'cs_CZ',
            'cy' => 'cy_GB', 'da' => 'da_DK', 'de' => 'de_DE', 'dv' => 'dv_MV', 'el' => 'el_GR',
            'en' => 'en_US', 'es' => 'es_ES', 'et' => 'et_EE', 'eu' => 'eu_ES', 'fa' => 'fa_IR',
            'ff' => 'ff_Latn', 'fi' => 'fi_FI', 'fo' => 'fo_FO', 'fr' => 'fr_FR',
            'fy' => 'fy_NL', 'ga' => 'ga_IE', 'gd' => 'gd_GB', 'gl' => 'gl_ES', 'gn' => 'gn_PY',
            'gu' => 'gu_IN', 'ha' => 'ha_Latn', 'he' => 'he_IL', 'hi' => 'hi_IN',
            'hr' => 'hr_HR', 'hu' => 'hu_HU', 'hy' => 'hy_AM', 'id' => 'id_ID', 'ig' => 'ig_NG',
            'ii' => 'ii_CN', 'is' => 'is_IS', 'it' => 'it_IT', 'iu' => 'iu_Latn',
            'ja' => 'ja_JP', 'ka' => 'ka_GE', 'kk' => 'kk_KZ', 'kl' => 'kl_GL', 'km' => 'km_KH',
            'kn' => 'kn_IN', 'ko' => 'ko_KR', 'kr' => 'kr_NG', 'ks' => 'ks_Arab',
            'ku' => 'ku_Arab', 'ky' => 'ky_KG', 'la' => 'la_Latn', 'lb' => 'lb_LU',
            'lo' => 'lo_LA', 'lt' => 'lt_LT', 'lv' => 'lv_LV', 'mi' => 'mi_NZ', 'mk' => 'mk_MK',
            'ml' => 'ml_IN', 'mn' => 'mn_MN', 'mr' => 'mr_IN', 'ms' => 'ms_BN', 'mt' => 'mt_MT',
            'my' => 'my_MM', 'nb' => 'nb_NO', 'ne' => 'ne_NP', 'nl' => 'nl_NL', 'nn' => 'nn_NO',
            'oc' => 'oc_FR', 'om' => 'om_ET', 'or' => 'or_IN', 'pa' => 'pa_IN', 'pl' => 'pl_PL',
            'ps' => 'ps_AF', 'pt' => 'pt_BR', 'rm' => 'rm_CH', 'ro' => 'ro_RO', 'ru' => 'ru_RU',
            'rw' => 'rw_RW', 'sa' => 'sa_IN', 'sd' => 'sd_Arab', 'se' => 'se_SE',
            'si' => 'si_LK', 'sk' => 'sk_SK', 'sl' => 'sl_SI', 'so' => 'so_SO', 'sq' => 'sq_AL',
            'sr' => 'sr_Cyrl', 'st' => 'st_ZA', 'sv' => 'sv_SE', 'sw' => 'sw_KE',
            'ta' => 'ta_IN', 'te' => 'te_IN', 'tg' => 'tg_Cyrl', 'th' => 'th_TH',
            'ti' => 'ti_ER', 'tk' => 'tk_TM', 'tn' => 'tn_BW', 'tr' => 'tr_TR', 'ts' => 'ts_ZA',
            'tt' => 'tt_RU', 'ug' => 'ug_CN', 'uk' => 'uk_UA', 'ur' => 'ur_IN', 'uz' => 'uz_Latn',
            've' => 've_ZA', 'vi' => 'vi_VN', 'wo' => 'wo_SN', 'xh' => 'xh_ZA', 'yi' => 'yi_Hebr',
   ...
   public final function formatSize($size, $digits = 0, $binary = true,
      $thinsp = false) {
      static $binaryPrefixes = ['B', 'KiB', 'MiB', 'GiB', 'TiB', 'EiB', 'ZiB', 'YiB'];
   ...
   public final function formatNumber($number,
      $format = NumberFormatter::DECIMAL, $type = NumberFormatter::TYPE_DEFAULT) {
   ...
   public final function formatDate($timestamp,
      ...
      if(!isset($this->dateFormatters[$hash]))
         $this->dateFormatters[$hash] = new IntlDateFormatter($this->name,
            $format, IntlDateFormatter::NONE, $this->timeZone, $this->calendar);
   ...
   public final function formatTime($timestamp,
      ...
      if(!isset($this->dateFormatters[$hash]))
         $this->dateFormatters[$hash] = new IntlDateFormatter($this->name,
            IntlDateFormatter::NONE, $format, $this->timeZone, $this->calendar);
      return $this->dateFormatters[$hash]->format($timestamp);
   }
   ...
   public final function parseNumber($number,
      $format = NumberFormatter::DECIMAL, $type = NumberFormatter::TYPE_DOUBLE) {
      if(!isset($this->numberFormatters[$format]))
         $this->numberFormatters[$format] = new NumberFormatter($this->name,
            $format);
